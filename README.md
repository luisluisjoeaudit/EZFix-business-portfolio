...
## Our Impact
Initially, our business relied on a n8n server to allow our clients to input their device model and hardware defects, with only a 50% success rate of inputting the correct data 
